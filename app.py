...
from src.cam_dl import VideoTransformer as VT
...
def main():
    ...
    activities = ["Homepage","Deepface with webcam", "Deepface with picture", "Deep learning with webcam", "Deep learning with picture"]
    ...
    #Navigating to face emotion detction with deepface on live web-cam
    if choice == "Deepface with webcam":
    ...
    #Navigating to face emotion detection with deepface on picture
    if choice == "Deepface with picture":
